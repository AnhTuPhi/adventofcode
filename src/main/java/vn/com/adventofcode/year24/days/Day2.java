package vn.com.adventofcode.year24.days;

import vn.com.adventofcode.year24.Day2024;

import java.util.stream.IntStream;

/**
 * @author : AnhTuPhi
 * @created : 12/1/2024 - 11:29 PM - Sunday
...
public class Day2 extends Day2024 {
    ...
    private boolean isSafeReport(String report) {
        ...
        for (int i = 1; i < levels.length; i++) {
            int diff = Integer.parseInt(levels[i].replace("\r", "")) - Integer.parseInt(levels[i - 1]);
